...
class ApplicationMain {
	...
	public static function getAsset (inName:String):Dynamic {
		...
		if (inName=="gfx/swordguy.png")
			 
            return Assets.getBitmapData ("gfx/swordguy.png");
...
class NME_gfx_swordguy_png extends nme.display.BitmapData { public function new () { super (0, 0); } }
